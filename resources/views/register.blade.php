  ...
  <form class="relative bg-white max-w-md mx-auto top-52 z-10">
      <div class="flex min-h-full bg-gray-white rounded-[20px] flex-col justify-center items-center gap-5">
          ...
          <div class="flex-col gap-2 flex">
            ...
            <input type="text" name="nama" id="nama" autocomplete="nama" class="w-[375px] h-[38px] px-5 py-2.5 bg-neutral-200 rounded-md shadow justify-start items-center gap-2.5 inline-flex" placeholder="Nama">

              <div class="mt-5 text-stone-900 text-sm font-normal font-['Poppins']">Masukan Username yang ingin kamu gunakan</div>

              <input type="text" name="username" id="username" autocomplete="username" class="w-[375px] h-[38px] px-5 py-2.5 bg-neutral-200 rounded-md shadow justify-start items-center gap-2.5 inline-flex" placeholder="Username">

            <a href="/register2" class="mt-2 self-stretch px-5 py-2.5 bg-emerald-500 rounded-md shadow justify-center items-center gap-2.5 inline-flex text-white text-sm font-normal leading-[18px] hover:bg-red-500">
