<div class="relative mb-[80px]">
    <header class="fixed top-[-40px] left-0 right-0 mx-auto bg-white pb-[10px] border-b border-slate-900/10">
      <div class="container relative">
          <div class="header-wrapper flex justify-between items-center">
              <a href="/homepage">
                  <div class="text-zinc-700 text-4xl font-bold font-sans leading-[54px] tracking-[2.52px] mr-[45px] mt-[25px]">BAKA</div>
              </a>
              ...
              <div class="search mt-[25px] w-[450px] h-10 px-4 py-2 bg-gray-200 rounded-[10px] justify-start items-center gap-5 inline-flex">
                  <form action="#">
                    ...
                    <input class="bg-transparent w-[350px] ml-[20] py-2 border-0 outline-0 text-zinc-700 text-opacity-60 text-sm font-normal font-['Nunito']" type="text" placeholder="Search" />
                  </form>
                </div>
  
              <div class="menu-bar mt-[25px] w-[100px] h-[20px] pl-[79px] justify-end items-center gap-2.5 inline-flex" id="menu-bar">
...
<div class="w-[200px] h-[318px] pb-5 flex-col justify-center items-start gap-2.5 inline-flex fixed top-[90px] left-[20px]">
    ...
    <a href="/" class="self-stretch px-4 py-2 hover:bg-zinc-100 rounded-[7px] justify-start items-center gap-2.5 inline-flex">
      ...
      <div class="text-zinc-700 text-xs font-medium font-['Poppins'] leading-[18px] tracking-wide">Notifikasi</div>
    </a>

    <a href="/" class="self-stretch px-4 py-2 hover:bg-zinc-100 rounded-[7px] justify-start items-center gap-2.5 inline-flex">
      <div class="w-[14px] h-[15px] relative"></div>
      <div class="text-zinc-700 text-xs font-medium font-['Poppins'] leading-[18px] tracking-wide">Riwayat Aktifitas</div>
    </a>
    ...
    <a href="/" class="self-stretch px-4 py-2 hover:bg-zinc-100 rounded-[7px] justify-start items-center gap-2.5 inline-flex">
      <div class="w-[14px] h-[15px] relative"></div>
      <div class="text-zinc-700 text-xs font-medium font-['Poppins'] leading-[18px] tracking-wide">Pengaturan</div>
    </a>
