<div class="max-w-[300px] h-auto flex-col flex items-center justify-center fixed">
    ...
    <ul class="space-y-2 font-medium">
        <li>
           <a href="#" class="text-white bg-zinc-600 hover:bg-zinc-800 focus:ring-4 focus:ring-zinc-300 dark:bg-zinc-600 dark:hover:bg-zinc-700 dark:focus:ring-zinc-800 font-medium rounded-lg text-sm px-5 py-2 inline-flex text-center dark:focus:ring-[#3b5998]/55">
