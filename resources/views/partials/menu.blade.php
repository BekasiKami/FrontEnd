<div class="menu-bar h-[20px] ml-7 justify-end items-center gap-10 inline-flex">
    ...
    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="inline-flex items-center" type="button"><img
            src="assets/images/menu-bar-icon.svg" alt="">
    </button>
        ...
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
            ...
            <li>
                <a data-modal-target="modal-laporan" data-modal-toggle="modal-laporan"
                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Laporan Masalah</a>
            </li>
            <li>
